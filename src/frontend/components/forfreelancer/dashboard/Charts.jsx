        ...
        <div className="flex-fill card">
          ...
          <div className="pro-body">
            ...
            <ul className="static-list">
              <li>
                <span>
                  <i className="fas fa-circle text-violet me-1" /> Applied Jobs
                </span>{" "}
              ...
              <li>
                <span>
                  <i className="fas fa-circle text-yellow me-1" /> Applied
                  Proposals
                </span>{" "}
                <span className="sta-count">30</span>
              </li>
              <li>
                <span>
                  <i className="fas fa-circle text-blue me-1" /> Bookmarked
                  Projects
                </span>{" "}
                <span className="sta-count">30</span>
              </li>
